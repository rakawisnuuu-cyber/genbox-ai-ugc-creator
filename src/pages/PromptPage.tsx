...
const PromptPage = () => (
  <div className="flex flex-col items-center justify-center min-h-[60vh] text-center animate-fade-up">
    ...
    <h1 className="text-xl font-bold font-satoshi text-foreground mb-2">Prompt Generator segera hadir...</h1>
    <p className="text-sm text-muted-foreground max-w-xs">AI akan membantu optimize prompt kamu untuk hasil terbaik</p>
    <Link
      to="/dashboard"
