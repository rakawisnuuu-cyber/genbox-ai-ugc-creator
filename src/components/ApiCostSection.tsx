...
const simCards = [
  {
    title: "Pemula",
    desc: "50 gambar + 10 video / bulan",
    models: "Pakai: Nano Banana 2 (2K) + Grok 6s",
    calc: "(50 × Rp 960) + (10 × Rp 1.600)",
    total: 64000,
    vs: "vs. hire fotografer: Rp 500.000+",
  },
  {
    title: "Aktif",
    desc: "150 gambar + 1 video 24s/hari (Veo 3.1 Fast)",
    models: "Pakai: Nano Banana Pro (2K) + Veo 3.1 Fast × 3 clip/hari",
    calc: "(150 × Rp 1.440) + (90 × Rp 6.400)",
    total: 792000,
    vs: "vs. content agency: Rp 5.000.000+",
  },
  {
    title: "Power User",
    desc: "300 gambar + 2 video 24s/hari (Veo 3.1 Fast)",
    models: "Pakai: Nano Banana Pro (2K) + Veo 3.1 Fast × 6 clip/hari",
    calc: "(300 × Rp 1.440) + (180 × Rp 6.400)",
    total: 1584000,
    vs: "vs. full production: Rp 15.000.000+",
  },
];
