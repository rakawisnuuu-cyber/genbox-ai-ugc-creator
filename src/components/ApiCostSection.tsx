...
const simCards = [
  {
    ...
    calc: "(5 × Rp 1.440 + 3 × Rp 6.400) × 30 hari",
    total: 792000,
    vs: "Di Higgsfield/Runway: ~Rp 2.400.000+/bulan (atau habis credit)",
  },
  {
    title: "Brand / Agency",
    desc: "3 video 24s + 15 gambar / hari",
    models: "Nano Banana Pro (2K) + Veo 3.1 Fast",
    calc: "(15 × Rp 1.440 + 9 × Rp 6.400) × 30 hari",
    total: 2376000,
    vs: "Di platform lain: subscription Rp 5jt+ habis dalam minggu pertama",
  },
  {
    title: "Hemat Mode",
    desc: "1 video 24s + 5 gambar / hari",
    models: "Nano Banana 2 (2K) + Seedance 1.5 Pro",
    calc: "(5 × Rp 960 + 3 × Rp 4.480) × 30 hari",
    total: 547200,
    vs: "Lebih murah dari langganan Netflix Premium ☕",
  },
];
