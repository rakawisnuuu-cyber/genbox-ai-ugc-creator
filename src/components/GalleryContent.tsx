                ...
                return (
                  ...
                  >
                    ...
                    <div className="absolute top-2 left-2">
                      <span className="text-[9px] font-bold bg-primary/90 text-primary-foreground px-1.5 py-0.5 rounded-full">
                        VIDEO
                      </span>
                    </div>
                    <div className="absolute bottom-2 left-2 opacity-0 group-hover:opacity-100 transition-opacity">
                      <span className="text-[9px] bg-background/80 text-foreground px-1.5 py-0.5 rounded-full">
                        {item.model}
                      </span>
                    </div>
                  </div>
              ...
              return (
                ...
                >
                  <div className="aspect-square relative">
                    ...
                    {item.upscale_factor && (
                      <span className="absolute top-2 left-2 bg-primary/15 text-primary text-[9px] rounded-full px-1.5 py-0.5 font-medium">
      ...
      {detailItem && (
        ...
        >
          <div
            ...
            className="bg-card border border-border rounded-xl max-w-lg w-full max-h-[90vh] overflow-y-auto p-5 space-y-4 animate-scale-in"
          >
