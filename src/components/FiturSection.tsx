...
const characters = [
  { name: "Hijab Casual", image: "https://hgwojnluqkrypwttytxb.supabase.co/storage/v1/object/public/preset-characters/Hijab%20Casual.jpeg" },
  { name: "Urban Trendy", image: "https://hgwojnluqkrypwttytxb.supabase.co/storage/v1/object/public/preset-characters/Urban%20Trendy.jpeg" },
  { name: "Ibu Muda", image: "https://hgwojnluqkrypwttytxb.supabase.co/storage/v1/object/public/preset-characters/Ibu%20Muda.jpeg" },
  { name: "Gen-Z Creator", image: "https://hgwojnluqkrypwttytxb.supabase.co/storage/v1/object/public/preset-characters/Gen-Z%20Creator.jpeg" },
  { name: "Beauty Enthusiast", image: "https://hgwojnluqkrypwttytxb.supabase.co/storage/v1/object/public/preset-characters/Beauty%20Enthusiast.jpeg" },
  { name: "Bapak UMKM", image: "https://hgwojnluqkrypwttytxb.supabase.co/storage/v1/object/public/preset-characters/Bapak%20UMKM.jpeg" },
  { name: "Mahasiswa", image: "https://hgwojnluqkrypwttytxb.supabase.co/storage/v1/object/public/preset-characters/Mahasiswa.jpeg" },
  { name: "Office Worker", image: "https://hgwojnluqkrypwttytxb.supabase.co/storage/v1/object/public/preset-characters/Office%20Worker.jpeg" },
  { name: "Ibu PKK", image: "https://hgwojnluqkrypwttytxb.supabase.co/storage/v1/object/public/preset-characters/Ibu%20PKK.jpeg" },
  { name: "Cowok Gym", image: "https://hgwojnluqkrypwttytxb.supabase.co/storage/v1/object/public/preset-characters/Cowok%20Gym.jpeg" },
];
            ...
            <div className="rounded-2xl overflow-hidden border border-white/10 shadow-2xl">
              <div className="relative h-[280px] overflow-hidden">
                ...
                <div className="absolute right-2 top-2">
                  <span className="rounded bg-black/30 px-1.5 py-0.5 text-[8px] font-semibold uppercase tracking-wider text-white/50 backdrop-blur-sm">Preset</span>
                </div>
  ...
  return (
    <div className="relative mx-auto w-full max-w-[280px] overflow-hidden rounded-2xl border border-border/60 bg-card/80">
      <div className="relative aspect-[9/16] w-full">
        <video ref={videoRef} src="https://hgwojnluqkrypwttytxb.supabase.co/storage/v1/object/public/showcase-videos/fitur-video.mov" className="h-full w-full object-cover" autoPlay loop muted playsInline />
        ...
        <button onClick={toggleMute} className="absolute bottom-3 right-3 z-10 flex h-8 w-8 items-center justify-center rounded-full bg-background/70 backdrop-blur-sm border border-border/40 transition-colors hover:bg-background/90">
          {muted ? (
...
const features = [
  ...
  },
  {
    ...
    desc: "Upload foto produk, pilih karakter dan pose. AI generate gambar UGC yang kelihatan kayak difoto beneran.",
...
const ModuleCard = ({
  ...
  <div
    className={`rounded-3xl border border-border/40 bg-card/30 p-8 sm:p-10 transition-all duration-500 hover:border-cream/15 hover:bg-card/50 ${isVisible ? "animate-fade-up" : "opacity-0"}`}
    style={{ animationDelay: `${delay}s` }}
  >
    <div className="flex items-center gap-3 mb-3">
      <span className="font-mono text-[11px] font-bold uppercase tracking-widest text-cream/40">{num}</span>
      <Icon size={16} className="text-cream/30" />
    </div>

    <h3 className="font-serif text-2xl sm:text-3xl tracking-tight text-cream">{title}</h3>
    <p className="mt-3 font-body text-sm text-muted-foreground max-w-lg leading-relaxed">{desc}</p>
    ...
    <div className="mt-8">
      {animation === "video" ? (
        <video
          ...
          className="w-full rounded-xl border border-border/30 shadow-[0_8px_32px_-8px_rgba(0,0,0,0.4)]"
        />
      ) : (
        <div className="relative w-full overflow-hidden rounded-xl border border-border/30 shadow-[0_8px_32px_-8px_rgba(0,0,0,0.4)]">
          <div className="flex items-center gap-1.5 border-b border-border/30 bg-secondary/40 px-3 py-2">
            ...
            <div className="ml-2 flex-1 rounded bg-background/40 px-2 py-0.5 text-[8px] text-muted-foreground/30 font-mono">genbox.app</div>
          </div>
          <img
            src={animation === "character-stack"
...
const FiturSection = () => {
  ...
  return (
    <section id="fitur" ref={ref} className="relative z-10 px-4 py-20 sm:py-32">
      <div className="mx-auto max-w-5xl">
        {/* Left-aligned header like B2Bizz */}
